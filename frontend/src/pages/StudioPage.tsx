...
export default function StudioPage() {
  ...
  return <main className="studio-shell branded-workspace" aria-labelledby="studio-title">
    <aside className="workspace-sidebar" aria-label="Contexto de Studio Insights">
      <BrandLogo />
      <div className="workspace-sidebar__section">
        <p className="workspace-sidebar__label">Analítica y aprendizaje</p>
        <strong>Fase 5</strong>
        <span>Reportes, simulación, indicadores y aprendizaje aplicado.</span>
      </div>
    </aside>
