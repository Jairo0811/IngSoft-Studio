...
export default function ProjectsPage() {
  ...
  return <main className="workspace-shell branded-workspace" aria-labelledby="projects-title">
    <aside className="workspace-sidebar" aria-label="Contexto de IngSoft Studio">
      <BrandLogo />
      <div className="workspace-sidebar__section">
        <p className="workspace-sidebar__label">Ingeniería de requisitos</p>
        <strong>Fase 3</strong>
        <span>Alcance, historias de usuario, casos de uso y prioridades MoSCoW.</span>
      </div>
    </aside>

    <section className="workspace-main">
      <WorkspaceNav />
      <header className="workspace-header workspace-header--brand">
        <div><p className="eyebrow">Fase 3 · Ingeniería de Requisitos</p><h1 id="projects-title">Proyectos y <span>requisitos</span></h1><p>Gestiona el alcance funcional, historias de usuario, casos de uso y prioridades MoSCoW.</p></div>
      </header>
